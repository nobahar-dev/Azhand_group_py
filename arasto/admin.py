...
@admin.register(ArastoArticles)
class ArastoArticleAdmin(admin.ModelAdmin):
...
@admin.register(ArastoCategory)
class ArastoCategoryAdmin(admin.ModelAdmin):
    list_display = ('title', 'slug', 'date_created', 'date_updated')
    list_filter = ('date_created', 'date_updated')
    
    
@admin.register(ArastoComment)
class ArastoCommentAdmin(admin.ModelAdmin):
