...
class HumanArticleAdmin(admin.ModelAdmin):
...
@admin.register(HumanCategory)
class HumanCategoryAdmin(admin.ModelAdmin):
    list_display = ('title', 'slug', 'date_created', 'date_updated')
    list_filter = ('date_created', 'date_updated')
    
    
@admin.register(HumanComment)
class HumanCommentAdmin(admin.ModelAdmin):
